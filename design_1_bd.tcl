...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set pwmA_o_0 [ create_bd_port -dir O pwmA_o_0 ]
  set pwmB_o_0 [ create_bd_port -dir O pwmB_o_0 ]
  ...
  # Create instance: deadband, and set properties
  set deadband [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 deadband ]
  ...
  # Create instance: duty, and set properties
  set duty [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 duty ]
  set_property -dict [ list \
   CONFIG.DIN_FROM {7} \
   CONFIG.DIN_TO {0} \
   CONFIG.DIN_WIDTH {32} \
  ...
  connect_bd_net -net Pwm_0_pwmA_o [get_bd_ports pwmA_o_0] [get_bd_pins Pwm_0/pwmA_o]
  connect_bd_net -net Pwm_0_pwmB_o [get_bd_ports pwmB_o_0] [get_bd_pins Pwm_0/pwmB_o]
  connect_bd_net -net deadband_Dout [get_bd_pins Pwm_0/band_i] [get_bd_pins deadband/Dout]
  connect_bd_net -net duty_Dout [get_bd_pins Pwm_0/duty_i] [get_bd_pins duty/Dout]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins Pwm_0/clk_i] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins Pwm_0/n_reset_i] [get_bd_pins processing_system7_0/FCLK_RESET0_N]
  connect_bd_net -net processing_system7_0_GPIO_O [get_bd_pins deadband/Din] [get_bd_pins duty/Din] [get_bd_pins processing_system7_0/GPIO_O]
